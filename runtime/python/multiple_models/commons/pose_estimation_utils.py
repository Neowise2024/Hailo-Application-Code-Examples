...
class PoseEstPostProcessing:
    ...
    def preprocess_with_info(self, image: Image.Image, model_w: int, model_h: int) -> tuple:
        """
        Resize image with unchanged aspect ratio using padding and return transformation info.
        ...
        Returns:
            tuple: (preprocessed image, transformation info)
        """
